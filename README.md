...
Answer: It makes the website accessible to everyone, including those with limitations and disabilities.

2. Talk about 3 different things you can do to ensure your website is accessible. 

Answer: Responsive design, semantic code, and limiting the use of otherwise restrictive coloring on the website for colorblind persons.

3. How would you explain the concept of a variable to someone new to programming?

Answer: Variables are assigned JS elements that can be utilized further down in the index.js. 

4. What is the purpose of using functions in code?

Answer: Functions are used with JS, making the webpage more responsive with particular if/for/while/else statements.
